...
// POST /api/paymob/pay  — called after createOrder
const initiatePayment = asyncWrapper(async (req, res, next) => {
  ...
  // Save paymobOrderId to our order
...
// POST /api/paymob/webhook  — Paymob calls this after payment
